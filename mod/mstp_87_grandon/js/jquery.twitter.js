	...
	$.fn.getTwitter = function(options) {
		...
		return this.each(function() {
			...
			if (o.showProfileLink) {
				var profileLinkHTML = "<p class=\"profileLink\"><a href=\"#/"+o.userName+"\">#/"+o.userName+"</a></p>";
			...
			$.ajax({
				...
				success: function(data) {
					...
					$.each(data, function(key, val) {
						...
						if (o.showTimestamp) tweetHTML += " <a style=\"font-size:85%\" href=\"#/" + o.userName + "/statuses/" + val.id_str + "\">" + relative_time(val.created_at) + "</a>";
		...
		// sourced from #/javascripts/blogger.js
